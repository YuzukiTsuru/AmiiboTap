...
AMIIBIN *Amiitool::load_amiibo_data(const char *file_path) {
...
void Amiitool::amiibo_encryption(AMIIBIN *amiibo) {
    nfc3d_amiibo_pack(&amiibo_keys, amiibo, modified_amiibo);
}

void Amiitool::amiibo_decryption(AMIIBIN *amiibo) {
...
AMIIBIN *Amiitool::get_amiibo_data() {
